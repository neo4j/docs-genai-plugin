...
Neo4j's link:{neo4j-docs-base-uri}/cypher-manual/indexes/semantic-indexes/vector-indexes[vector indexes] and link:{neo4j-docs-base-uri}/cypher-manual/functions/vector[vector functions] allow you to calculate the similarity between node and relationship properties in a graph.
