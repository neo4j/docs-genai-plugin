...
<7> Set to `1` the amount of batches to be processed at once (see link:{neo4j-docs-base-uri}/cypher-manual/current/subqueries/subqueries-in-transactions/#concurrent-transactions[`CALL` subqueries -> Concurrent transactions]).
